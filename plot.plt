...
#splot [x=0:a] [y=0:b] sqrt(2/a) * sin(pi * x * n / a) * sqrt(2/b) * sin(pi * y * n / b) # for 3d
#plot [x=0:a] [y=-1.5:b] sqrt(2/a) * sin(pi * x * 1 / a) ti "n = 1", sqrt(2/a) * sin(pi * x * 2 / a) ti "n = 2", sqrt(2/a) * sin(pi * x * 3 / a) ti "n = 3", sqrt(2/a) * sin(pi * x * 4 / a) ti "n = 4"
